...
class TestModelLookup(TestCase):
    ...
    def commit_user(self):
        user = User(email="james@email.com", password_hash="password")
        db.session.add(user)
        db.session.commit()
        return user
    ...
    def test_transaction_details(self):
        ...
        tx = self.commit_tx()
        tx = Transactions.query.first()

        tx_detail = transaction_details(
        ...
        tx_details = transaction_details.query.all()
